...
if __name__ == '__main__':
    ...
    if start_date <= lastTradeDate:
        ...
        parse_stock_data.refresh_all_stock_day_k_no_adjust_first_time(start_date, lastTradeDate, current_date)
        print("start to refresh all stock day K")
        parse_stock_data.refresh_all_stock_day_k_first_time(start_date, lastTradeDate, current_date)
